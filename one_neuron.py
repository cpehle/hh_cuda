...
dt = 6.014 # 6.014 при такой начальной фазе и больше через несколько периодов наступает смерть колебаний
...
#                           'spike_weights': [7., 9., 2.]})
stimSpkTimes = [dt]# + 1*T*i for i in xrange(100)]
...
#    dtPost[idx] = dt + 1*T - spike_times[1]
#else:
#    dtPost[idx] = nan
#%%
...
#
#np.save('phase_map2.npy', (dts, dtPost))
